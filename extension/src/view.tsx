  ...
  return (
    <main className="max-w-screen-xl p-4 pt-8 mx-auto">
      ...
      <section className={classnames(
          ...
          products.length > 0 ? "grid-cols-1 md:grid-cols-2 xl:grid-cols-3" : "grid-cols-1"
        )}>
        {products.length > 0 ? (
          products.map((product) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-4">
                ...
                <div className="relative flex flex-wrap items-end justify-between gap-2 mt-auto">
                  ...
                  {product.description && (
                    <div className={classnames(
                      "absolute opacity-0 hidden max-w-80 bg-gray-50 p-2 flex-col gap-2 shadow-2xl border border-dashed border-gray-500 rounded-md bottom-0 left-0 transform transition-all max-h-96 overflow-y-auto",
